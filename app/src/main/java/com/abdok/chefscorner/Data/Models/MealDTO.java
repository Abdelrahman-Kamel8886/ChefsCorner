...
public class MealDTO implements Serializable {
    ...
    public ArrayList<IngredientFormatDTO> getIngredients(){
        ...
        addIngredients(ingredients,getStrIngredient4(),getStrMeasure4());
        addIngredients(ingredients,getStrIngredient5(),getStrMeasure5());
        addIngredients(ingredients,getStrIngredient6(),getStrMeasure6());
        addIngredients(ingredients,getStrIngredient7(),getStrMeasure7());
        addIngredients(ingredients,getStrIngredient8(),getStrMeasure8());
        addIngredients(ingredients,getStrIngredient9(),getStrMeasure9());
        addIngredients(ingredients,getStrIngredient10(),getStrMeasure10());
        addIngredients(ingredients,getStrIngredient11(),getStrMeasure11());
        addIngredients(ingredients,getStrIngredient12(),getStrMeasure12());
        addIngredients(ingredients,getStrIngredient13(),getStrMeasure13());
        addIngredients(ingredients,getStrIngredient14(),getStrMeasure14());
        addIngredients(ingredients,getStrIngredient15(),getStrMeasure15());
        addIngredients(ingredients,getStrIngredient16(),getStrMeasure16());
        addIngredients(ingredients,getStrIngredient17(),getStrMeasure17());
